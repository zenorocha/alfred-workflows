...
### [Dash](https://github.com/willfarrell/alfred-dash-workflow) (1.22) ~ [Download](http://zno.io/Rc3p)
...
> Triggers: `dash`, `html`, `css`, `js`, `jquery`, `jqueryui`, `angularjs`, `bootstrap`, `svg`, `nodejs`, `php`, `redis`, `mysql`, `man`, `cpp`, `sass`, `compass`, `backbone`, `underscore`,  `wordpress`, `drupal`, `django`, `python`, `python2`, `elisp`, `android`, `yui`, `ruby`, `rails`, `gem`, `bourbon`, `neat`, `jade`, `stylus`, `coffee`, `knockout`, `erlang`, `lua`, `foundation`, `vim`, `bash`, `mongodb`.
